...
def register():
    if request.method == 'POST':
        ...
        try:
            ...
            flash('Username already exists.', 'error')  # Handle username already exists error
            return render_template('register.html')  # Render the registration page again to show the error message
    return render_template('register.html')  # Render the registration page on GET request
